...
export class MeetingService {
  ...
  /**
   * Creates a new past meeting attachment via ITX proxy
   */
  ...
  /**
   * Updates an existing past meeting attachment via ITX proxy
   */
  public async updatePastMeetingAttachment(
    req: Request,
    pastMeetingUid: string,
    attachmentUid: string,
    updateData: UpdateMeetingAttachmentRequest
  ): Promise<void> {
    logger.debug(req, 'update_past_meeting_attachment', 'Updating past meeting attachment', { past_meeting_id: pastMeetingUid, attachment_uid: attachmentUid });

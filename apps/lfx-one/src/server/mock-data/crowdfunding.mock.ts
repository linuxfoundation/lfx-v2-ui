  ...
  opentelemetry: [
    {
      ...
      amount_cents: 500000,
      date: '2026-05-10',
      donor_name: 'Google Cloud',
      donor_type: 'organization',
      donor_logo_url: 'https://avatars.githubusercontent.com/u/2810941?v=4',
      initiative_id: 'b3f2c1a0-1111-4aaa-8bbb-c0d0e0f01234',
      kind: 'one-time',
    },
    {
      id: 'txn-otel-2',
      ...
      amount_cents: 250000,
      date: '2026-05-08',
      donor_name: 'Microsoft',
      donor_type: 'organization',
      donor_logo_url: 'https://avatars.githubusercontent.com/u/6154722?v=4',
      initiative_id: 'b3f2c1a0-1111-4aaa-8bbb-c0d0e0f01234',
      kind: 'one-time',
    },
    {
      ...
      donor_name: 'Datadog',
      donor_type: 'organization',
      donor_logo_url: 'https://avatars.githubusercontent.com/u/365230?v=4',
      initiative_id: 'b3f2c1a0-1111-4aaa-8bbb-c0d0e0f01234',
      kind: 'one-time',
    },
    {
    ...
    },
    {
      ...
      amount_cents: 120000,
      date: '2026-04-15',
      category: 'Maintainer Stipend',
      donor_name: 'Maintainer Stipends Q1',
      initiative_id: 'b3f2c1a0-1111-4aaa-8bbb-c0d0e0f01234',
      kind: 'one-time',
    },
    {
      ...
      donor_name: 'CI/CD Infrastructure',
      initiative_id: 'b3f2c1a0-1111-4aaa-8bbb-c0d0e0f01234',
      kind: 'one-time',
    },
  ],
  'zephyr-security': [
    {
      ...
      amount_cents: 300000,
      date: '2026-05-12',
      donor_name: 'Nordic Semiconductor',
      donor_type: 'organization',
      donor_logo_url: 'https://avatars.githubusercontent.com/u/18768454?v=4',
      initiative_id: 'b3f2c1a0-2222-4aaa-8bbb-c0d0e0f05678',
      kind: 'one-time',
    },
    {
      id: 'txn-zephyr-2',
      ...
      donor_name: 'NXP',
      donor_type: 'organization',
      donor_logo_url: 'https://avatars.githubusercontent.com/u/32881135?v=4',
      initiative_id: 'b3f2c1a0-2222-4aaa-8bbb-c0d0e0f05678',
      kind: 'one-time',
    },
    {
      ...
      donor_name: 'Qualcomm',
      donor_type: 'organization',
      donor_logo_url: 'https://avatars.githubusercontent.com/u/3739855?v=4',
      initiative_id: 'b3f2c1a0-2222-4aaa-8bbb-c0d0e0f05678',
      kind: 'one-time',
    },
    {
      ...
      donor_name: 'Trail of Bits Audit Q1',
      initiative_id: 'b3f2c1a0-2222-4aaa-8bbb-c0d0e0f05678',
      kind: 'one-time',
    },
  ],
  ...
  curl: [
    {
      ...
      donor_type: 'individual',
      initiative_id: 'b3f2c1a0-4444-4aaa-8bbb-c0d0e0f0curl',
      kind: 'recurring',
    },
    {
      id: 'txn-curl-2',
  ...
  'rust-for-linux': [
    {
      ...
      donor_name: 'Current User',
      donor_type: 'individual',
      initiative_id: 'b3f2c1a0-5555-4aaa-8bbb-c0d0e0f0rust',
      kind: 'recurring',
    },
    {
      id: 'txn-rust-2',
...
export const MOCK_INITIATIVES: BackendInitiative[] = [
  ...
  },
  {
    ...
    status: 'active',
    description:
      'Funds professional security audits, CVE triage, and hardening work for the Zephyr RTOS — the open-source OS at the heart of billions of IoT and embedded devices worldwide.',
    industry: 'Security',
    color: '#f5a623',
...
export const MOCK_RECURRING_DONATIONS: RecurringDonation[] = [
  {
    ...
    description: "Sustaining the internet's most used data transfer tool — funding Daniel Stenberg's maintenance work and project infrastructure.",
    tags: ['Infrastructure', 'C', 'Open Source'],
    initiativeUrl: 'https://crowdfunding.lfx.linuxfoundation.org/projects/curl',
  },
  {
    id: 'rust-for-linux',
    name: 'Rust for Linux',
    ...
    initiativeSlug: 'rust-for-linux',
    totalContributed: 75,
    fundType: FundType.GENERAL_FUND,
    description: 'Supporting the integration of Rust as a first-class language in the Linux kernel for memory-safe systems programming.',
    tags: ['Linux Kernel', 'Rust', 'Systems'],
    initiativeUrl: 'https://crowdfunding.lfx.linuxfoundation.org/projects/rust-for-linux',
  },
];

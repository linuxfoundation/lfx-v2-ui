...
const MOCK_COMMITTEES = [
  {
    ...
    mailing_list: {
      uid: 'ml-gold-voting-001',
      name: 'gold-voting-class',
      url: 'https://lists.aaif.dev/g/gold-voting-class',
      subscriber_count: 24,
      audience_access: 'members',
    },
  ...
  },
  {
    ...
    join_mode: 'apply',
    mailing_list: {
      uid: 'ml-tac-general-002',
      name: 'tac-general',
      url: 'https://lists.aaif.dev/g/tac-general',
      subscriber_count: 45,
  ...
  },
  {
    ...
    total_members: 15,
    mailing_list: {
      uid: 'ml-security-wg-004',
      name: 'security-wg',
      url: 'https://lists.aaif.dev/g/security-wg',
      subscriber_count: 38,
      audience_access: 'members',
    },
  ...
  // ── Special Interest Group (SIG → special-interest-group) ──
  {
    ...
    join_mode: 'open',
    mailing_list: {
      uid: 'ml-supply-chain-009',
      name: 'supply-chain-sig',
      url: 'https://lists.aaif.dev/g/supply-chain-sig',
      subscriber_count: 85,
      audience_access: 'public',
    },

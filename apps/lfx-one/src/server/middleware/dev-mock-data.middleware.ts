...
const MOCK_COMMITTEES = [
  {
    ...
    mailing_list: { uid: 'ml-gold-voting-001', name: 'gold-voting-class', url: 'https://lists.aaif.dev/g/gold-voting-class', subscriber_count: 24, audience_access: 'members' },
  ...
  },
  {
    ...
    total_members: 12,
    join_mode: 'apply',
    mailing_list: { uid: 'ml-tac-general-002', name: 'tac-general', url: 'https://lists.aaif.dev/g/tac-general', subscriber_count: 45, audience_access: 'public' },
  ...
  },
  {
    ...
    enable_voting: false,
    total_members: 8,
    mailing_list: { uid: 'ml-outreach-003', name: 'outreach', url: 'https://lists.aaif.dev/g/outreach', subscriber_count: 18, audience_access: 'members' },
  ...
  },
  {
    ...
    enable_voting: true,
    total_members: 15,
    mailing_list: { uid: 'ml-security-wg-004', name: 'security-wg', url: 'https://lists.aaif.dev/g/security-wg', subscriber_count: 38, audience_access: 'members' },
  ...
  // ── Special Interest Group (SIG → special-interest-group) ──
  {
    ...
    total_members: 64,
    join_mode: 'open',
    mailing_list: { uid: 'ml-supply-chain-009', name: 'supply-chain-sig', url: 'https://lists.aaif.dev/g/supply-chain-sig', subscriber_count: 85, audience_access: 'public' },

...
const MOCK_BADGES: Badge[] = [
  // ── Certifications ──────────────────────────────────────────────────────────
  {
    ...
    description:
      'The CKA program was created by the CNCF, in collaboration with The Linux Foundation, to allow Kubernetes users to demonstrate competence in a hands-on, practical manner. A certified administrator has demonstrated the ability to do basic installation as well as configuring and managing production-grade Kubernetes clusters.',
  ...
  },
  {
    ...
    description:
      'The LFCS certifies that users can perform essential maintenance tasks on Linux, including first and junior-level Linux system administration. Holders have demonstrated the ability to support running systems and services, first-level troubleshooting and analysis, as well as deciding when to escalate issues to higher-level teams.',
  ...
  // ── Speaking ────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Awarded to individuals who delivered an accepted talk, workshop, or keynote at KubeCon + CloudNativeCon, the Cloud Native Computing Foundation's flagship event. Speakers contribute to the global cloud-native community by sharing expertise, research, and real-world experiences.",
    imageUrl: '',
  ...
  },
  {
    ...
    description:
      "Recognizes individuals who presented at the Linux Foundation's Open Source Summit, the premier event for open source developers, technologists, and community leaders. Speakers share insights across tracks including Linux kernel, open source leadership, community health, and diversity.",
    imageUrl: '',
    issuedBy: 'The Linux Foundation',
  ...
  // ── Event Participation ─────────────────────────────────────────────────────
  {
    ...
    description:
      "Awarded to registered attendees of KubeCon + CloudNativeCon, the Cloud Native Computing Foundation's largest annual conference. Attendees gain access to hundreds of sessions, keynotes, and co-located events covering the entire cloud-native ecosystem.",
    imageUrl: '',
    issuedBy: 'Cloud Native Computing Foundation (CNCF)',
  ...
  // ── Project Contribution ────────────────────────────────────────────────────
  {
    ...
    description:
      'Recognizes individual contributors who have made meaningful code, documentation, or community contributions to one or more CNCF-hosted projects. This badge celebrates the people who power the cloud-native ecosystem through their open source work.',
    imageUrl: '',
    issuedBy: 'Cloud Native Computing Foundation (CNCF)',
  ...
  // ── Program Committee ───────────────────────────────────────────────────────
  {
    ...
    description:
      "Awarded to individuals who served on the program committee for the Linux Foundation's Open Source Summit. Program committee members play a critical role in shaping the event by reviewing and selecting talk submissions and ensuring quality across all technical and community tracks.",
    imageUrl: '',
    issuedBy: 'The Linux Foundation',

...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, CardComponent, InputTextComponent, SelectComponent, ButtonComponent, ToastModule, TooltipModule],
...
export class ProfileEditComponent implements OnInit {
  ...
  private readonly profileSignal = signal<CombinedProfile | null>(null);
  ...
  public readonly profile = computed(() => this.profileSignal());
  ...
  public async onSubmit(): Promise<void> {
    ...
    try {
      ...
      // Update both user and profile data in parallel
      await Promise.all([firstValueFrom(this.userService.updateUserInfo(userUpdate)), firstValueFrom(this.userService.updateProfileDetails(profileUpdate))]);

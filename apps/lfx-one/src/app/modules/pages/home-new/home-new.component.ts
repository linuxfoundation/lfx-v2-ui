...
import type { MeetingItem, PendingActionItem, ProgressItem, ProjectItem } from '@lfx-one/shared/interfaces';
...
export class HomeNewComponent {
  ...
  protected readonly meetings: MeetingItem[] = [
    { title: 'Technical Steering Committee', time: 'Today, 2:00 PM', attendees: 12 },
    { title: 'Project Alpha Standup', time: 'Tomorrow, 10:00 AM', attendees: 8 },
    { title: 'Security Review', time: 'Friday, 3:00 PM', attendees: 5 },
  ];

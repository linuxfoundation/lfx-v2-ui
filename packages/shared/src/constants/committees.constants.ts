...
export function getCommitteeTypeColor(category: string | undefined): string {
  ...
  if (lowerCategory.includes('government')) return 'bg-purple-100 text-purple-800';
  ...
  if (lowerCategory.includes('technical mailing')) return 'bg-teal-100 text-teal-800';
  ...
  if (lowerCategory.includes('marketing mailing')) return 'bg-pink-100 text-pink-800';
  if (lowerCategory.includes('ambassador')) return 'bg-pink-100 text-pink-800';

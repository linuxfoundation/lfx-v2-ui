...
export interface DocumentDisplayItem {
  ...
  date?: string;
  fileSize?: number;
  /** Source for filtering: 'link', 'file', 'recording', 'transcript', 'summary', 'folder', or 'meeting' */
  source: string;
  /** Whether this is a standalone document (supports edit/delete) */
  isStandalone: boolean;
  /** Original meeting attachment data (for legacy download — upcoming meeting attachments) */
  ...
  // ── Enriched meeting document fields (from recordings/transcripts/summaries) ──
  /** Meeting title for the "From: ..." subtitle */
  meetingTitle?: string;
  /** Meeting UID — for attachment download APIs */
  meetingId?: string;
  /** Past meeting UID — for past meeting APIs */

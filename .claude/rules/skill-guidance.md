...
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/lfx-self-serve-code-review`      | Immediately after every commit — general code review on the diff (native disposition, no source citation) + convention audit against the documented rule surface (`.claude/rules/`, `docs/reviews/` checklists, architecture, upstream API contracts) with cross-check discipline. Audits the latest commit by default; pass `base: origin/main` for the pre-PR full-branch sweep on multi-commit branches. |

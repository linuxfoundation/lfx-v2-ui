...
The `--stat` header at the top of `git show`'s output is the canonical changed-file list — use those paths to drive Step 2's pattern-file routing. The shortstat line feeds the Step 6 report header.

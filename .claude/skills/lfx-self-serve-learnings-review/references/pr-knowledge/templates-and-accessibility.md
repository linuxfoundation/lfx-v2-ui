...
## `pr-knowledge/templates-and-accessibility/nested-interactive-elements` — SHOULD_FIX
...
## `pr-knowledge/templates-and-accessibility/icon-only-button-no-aria-label` — SHOULD_FIX
...
## `pr-knowledge/templates-and-accessibility/missing-aria-pressed-on-toggle` — SHOULD_FIX
...
## `pr-knowledge/templates-and-accessibility/click-without-keydown` — SHOULD_FIX
...
## `pr-knowledge/templates-and-accessibility/class-binding-clobbers-static-class` — SHOULD_FIX
...
## `pr-knowledge/templates-and-accessibility/for-track-not-stable-identity` — SHOULD_FIX
...
## `pr-knowledge/templates-and-accessibility/missing-lens-query-param-on-link` — SHOULD_FIX
...
## `pr-knowledge/templates-and-accessibility/style-binding-vs-class-utility` — NIT
